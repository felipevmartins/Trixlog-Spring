...
<body>
	...
	<div
		...
		<ul>
			<li class="list-group-item active">Lista de Locations Alteraveis</li>
			<c:forEach var="location" items="${listaLocations}">
				<a onclick="clicaalterarlocation(${location.id});"
	...
	<div id="alterar-location"
		...
		<form:form role="form" id="alterar-location-form"
			class="col-lg-6 cadatro-locations" method="put" action="editar">
